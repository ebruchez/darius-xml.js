...
trait XMLAttributes {
   ...
   */
  def setNonNormalizedValue(attrIndex: Int, attrValue: String): Unit
   ...
   * @param attrIndex The attribute index.
   */
  def isSpecified(attrIndex: Int): Boolean
   ...
   *                  the name has no Namespace URI.
   */
  def getAugmentations(uri: String, localPart: String): Augmentations
