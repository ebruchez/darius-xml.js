...
object EncodingMap {
  ...
  /**
   fIANA2JavaMap
   */
  protected val fIANA2JavaMap = new ju.HashMap[String, String]()

  /**
   fJava2IANAMap
   */
  protected val fJava2IANAMap = new ju.HashMap[String, String]()
   ...
   */
  def putIANA2JavaMapping(ianaEncoding: String, javaEncoding: String): Unit = {
   ...
   * for other applications running in the system.
   */
  def putJava2IANAMapping(javaEncoding: String, ianaEncoding: String): Unit = {
